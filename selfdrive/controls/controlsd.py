...
class Controls:
  def __init__(self, sm=None, pm=None, can_sock=None, CI=None):
    ...
    if self.CP.openpilotLongitudinalControl: #self.CP.carFingerprint in [CAR.SANTA_FE_HEV_2022]:
      rdr_fw = None
      ...
      if rdr_fw.fwVersion in [b'\xf1\x8799110S1500\xf1\x00TM__ SCC FHCUP      1.00 1.00 99110-S1500         ', b'TM__ SCC FHCUP      1.00 1.00 99110-S1500 \x04!\x15\x07    ', b'TMhe SCC FHCUP      1.00 1.00 99110-CL500 \x04$\x164    '] or True:
        for i in range(10):
          print("O yes")
        try:
          for i in range(40):
